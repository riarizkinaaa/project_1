                        ...
                        <div class="row">
                          <div class="col-12">
                            <div class="owl-carousel-16 owl-carousel owl-theme">
                              <div class="item">
                                <div class="card">
                                  <div class="top-dealerbox text-center"><img class="card-img-top" src="/template/assets/images/dashboard-2/1.png" alt="...">
                                    <h6>Thompson lee</h6>
                              ...
                              <div class="item">
                                <div class="card">
                                  <div class="top-dealerbox text-center"><img class="card-img-top" src="/template/assets/images/dashboard-2/8.png" alt="...">
                                    <h6>Johnson allon</h6>
                              ...
                              <div class="item">
                                <div class="card">
                                  <div class="top-dealerbox text-center"><img class="card-img-top" src="/template/assets/images/dashboard-2/3.png" alt="...">
                                    <h6>williams reed</h6>
                              ...
                              <div class="item">
                                <div class="card">
                                  <div class="top-dealerbox text-center"><img class="card-img-top" src="/template/assets/images/dashboard-2/4.png" alt="...">
                                    <h6> Jones king</h6>
                          ...
                          <div class="col-12">
                            <div class="owl-carousel-16 owl-carousel owl-theme">
                              <div class="item">
                                <div class="card">
                                  <div class="top-dealerbox text-center"><img class="card-img-top" src="/template/assets/images/dashboard-2/5.png" alt="...">
                                    <h6>Brown davis</h6>
                              ...
                              <div class="item">
                                <div class="card">
                                  <div class="top-dealerbox text-center"><img class="card-img-top" src="/template/assets/images/dashboard-2/6.png" alt="...">
                                    <h6>Wilson Hill</h6>
                              ...
                              <div class="item">
                                <div class="card">
                                  <div class="top-dealerbox text-center"><img class="card-img-top" src="/template/assets/images/dashboard-2/7.png" alt="...">
                                    <h6>Anderson ban</h6>
...
&lt;/div&gt;</code></pre>
                ...
                <div class="row">
                  ...
                  <div class="col-xl-6 box-col-6 top-sell-sec">
                    <div class="card">
                      ...
                      <div class="card-body">
                        <div class="media"><img class="img-fluid" src="/template/assets/images/dashboard-2/9.png" alt="">
   ...
   &lt;/div&gt;
   &lt;div class="card-body"&gt;
     &lt;div class="media"&gt;&lt;img class="img-fluid" alt="" src="/template/assets/images/dashboard-2/9.png"&gt;
       &lt;div class="media-body"&gt;
...
&lt;/div&gt;        </code></pre>
                      ...
                      <div class="media">
                        ...
                        <div class="media-body d-block">
                          ...
                          <ul class="timeline-pro">
                            <li>                                            <img class="img-fluid" src="/template/assets/images/dashboard-2/11.png" alt="Product-1"></li>
                            <li>                                        <img class="img-fluid" src="/template/assets/images/dashboard-2/10.png" alt="Product-2"></li>
                          </ul>
                        </div>
                      </div>
                      <div class="media">
 ...
 &lt;div class="card-body"&gt;
   &lt;div class="chart-main activity-timeline update-line"&gt;
    ...
    <!-- Plugins JS start-->
    <script src="/template/assets/js/chart/chartjs/chart.min.js"></script>
    ...
    <script src="/template/assets/js/owlcarousel/owl-custom.js"></script>
    <script src="/template/assets/js/dashboard/dashboard_2.js"></script>
    <!-- Plugins JS Ends-->
    <!-- Theme js-->
