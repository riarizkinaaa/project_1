                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form>
                              <div class="mb-3">
                                <label class="col-form-label" for="nama_desa">Desa</label>
                                <input class="form-control" type="text" name="nama_desa" value="@fat">
                              </div>
                              <div class="mb-3">
                        ...
                        <tbody>
                          ...
                          @foreach ($desa as $des)
                           <tr>
                             ...
                             <td>{{ $des->nama_desa }}</td>
                             <td> 
                             <a href="{{ route('desa.edit',$des->id_desa) }}"><i style="color: green" class="bi bi-pencil-square"></i></a>
                             </td>
                             <td>
                              <form action="{{ route('desa.destroy',$des->id_desa) }}" method="post">
                                @csrf
                                @method('delete')
