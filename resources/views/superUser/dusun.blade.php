                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form>
                              <div class="mb-3">
                                <label class="col-form-label" for="nama_dusun">Dusun</label>
                                <input class="form-control" type="text" name="nama_dusun" value="@fat">
                              </div>
                              <div class="mb-3">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="{{ route('dusun.store') }}" method="post">
                              ...
                              <div class="mb-3">
                                <label class="col-form-label" for="nama_dusun">Dusun</label>
                                <input class="form-control" name="nama_dusun" id="nama_dusun" type="text">
                              </div>
                            </form>
                          </div>
                      ...
                      <table class="display" id="custom-button">
                        ...
                        <tbody>
                          ...
                          @foreach ($dusun as $dus)
                           <tr>
                             <td>{{ $no++ }}</td>
                             <td>{{ $dus->nama_dusun }}</td>
                             <td> 
                             <a href="{{ route('dusun.edit',$dus->id_dusun) }}"><i style="color: green" class="bi bi-pencil-square"></i></a>
                             </td>
                             <td>
                              <form action="{{ route('dusun.destroy',$dus->id_dusun) }}" method="post">
                                @csrf
                                @method('delete')
