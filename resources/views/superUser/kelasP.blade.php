                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form>
                              <div class="mb-3">
                                <label class="col-form-label" for="kelas_pendidikan">Kelas pendidikan</label>
                                <input class="form-control" type="text" name="kelas_pendidikan" value="@fat">
                              </div>
                              <div class="mb-3">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="{{ route('kelas.store') }}" method="post">
                              ...
                              <div class="mb-3">
                                <label class="col-form-label" for="kelas_pendidikan">Kelas pendidikan</label>
                                <input class="form-control" name="kelas_pendidikan" id="kelas_pendidikan" type="text">
                              </div>
                            </form>
                          </div>
                        ...
                        <tbody>
                          ...
                          @foreach ($kelas as $kls)
                           <tr>
                             ...
                             <td> 
                             <a href="{{ route('kelas.edit',$kls->id_kelas_pendidikan) }}"><i style="color: green" class="bi bi-pencil-square"></i></a>
                             </td>
                             <td>
                              <form action="{{ route('kelas.destroy',$kls->id_kelas_pendidikan) }}" method="post">
                                @csrf
                                @method('delete')
