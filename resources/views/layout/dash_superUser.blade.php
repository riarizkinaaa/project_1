              ...
              <div id="mainnav">           
                <ul class="nav-menu custom-scrollbar">
                  ...
                  <li class="sidebar-main-title">
                    ...
                    <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="image"></i><span>anak</span></a>
                        <ul class="nav-submenu menu-content">
                          <li><a href="{{ route('anak.index') }}">form anak</a></li>
                        </ul>
                      </li>
                      <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="image"></i><span>pengalamatan</span></a>
                        <ul class="nav-submenu menu-content">
                          <li><a href="gallery.html">kecamatan</a></li>
                          <li><a href="gallery-with-description.html">desa</a></li>
                          <li><a href="gallery-masonry.html">dusun</a></li>
                        </ul>
                      </li>
                      <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="image"></i><span>pendidika</span></a>
                        <ul class="nav-submenu menu-content">
                            <li><a href="gallery-masonry.html">pendidikan</a></li>
                          <li><a href="gallery.html">prestasi formal</a></li>
                          <li><a href="gallery-with-description.html">prestasi nin_formal</a></li>
                          <li><a href="masonry-gallery-with-disc.html">kelas pendidikan</a></li>
                        </ul>
                      </li>
                      <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="image"></i><span>userlog</span></a>
                        <ul class="nav-submenu menu-content">
                          <li><a href="gallery.html">userlog</a></li>
                          <li><a href="gallery-with-description.html">role</a></li>
                        </ul>
                      </li>
